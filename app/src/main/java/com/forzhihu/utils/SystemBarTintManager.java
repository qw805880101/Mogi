...
public class SystemBarTintManager {
    ...
    private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (mConfig.isNavigationAtBottom()) {
            params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, mConfig
                    .getNavigationBarHeight());
            params.gravity = Gravity.BOTTOM;
        } else {
            params = new LinearLayout.LayoutParams(mConfig.getNavigationBarWidth(), LinearLayout.LayoutParams
                    .MATCH_PARENT);
